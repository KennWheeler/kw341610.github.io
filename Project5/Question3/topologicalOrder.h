...
public:
    ...
    int dfTopSort(int v, bool visited[], int topOrder[], int topIndex);
...
void topologicalOrderType::dfTopOrder()
{
 ...
 cout << "The code for Breadth-first toplogical order (pages 718-719) is provided in this file." << endl << endl;
 cout << "Implement the depth-first version (Ex. 7 on page 728) here. " << endl << endl;
 cout << "The functions graphType:depthFirstTraversal() and dft() on page 697 should be helpful." << endl << endl;


} //end dfTopOrder


int topologicalOrderType::dfTopSort(int v, bool visited[],
                                 int topOrder[], int topIndex)
{
