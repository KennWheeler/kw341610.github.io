...
{
    this->queueFront = NULL; //set front to null
    this->queueRear = NULL;  //set rear to null
...
void linkedQueueType<Type>::initializeQueue()
{
    ...
    while (this->queueFront!= NULL)  //while there are elements left
                               //in the queue
    {
        temp = this->queueFront;  //set temp to point to the 
                            //current node
        this->queueFront = this->queueFront->link;  //advance first to  
                                        //the next node
...
void linkedQueueType<Type>::addQueue(const Type& newElement)
{
    ...
    if (this->queueFront == NULL) //if initially the queue is empty
    {
    ...
    else        //add newNode at the end
    {
        ...
        this->queueRear = this->queueRear->link;
    }
}//end addQueue
...
void linkedQueueType<Type>::deleteQueue()
{
    ...
    if (!isEmptyQueue())
    {
        temp = this->queueFront;  //make temp point to the 
                            //first node
        this->queueFront = this->queueFront->link; //advance queueFront 

        delete temp;    //delete the first node

        if (this->queueFront == NULL) //if after deletion the 
                                //queue is empty
            this->queueRear = NULL;   //set queueRear to NULL
    }
    else
